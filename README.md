...
[![version](https://img.shields.io/badge/version-1.4.0-blue.svg)](https://github.com/j1617/battery-card)
...
- `--success-color` - 正常状态颜色
- `--warning-color` - 预警状态颜色
- `--error-color` - 紧急状态颜色
...
- **v1.4.0**：支持 HA 2024.x+ Grid布局和可见性、HA主题变量自动适配
- **v1.3.0**：新增横向三列显示模式
